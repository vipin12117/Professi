...
<form id="edd_register_form" class="edd_form" action="" method="post">
	...
	<fieldset>
		...
		<p>
			...
			<input class="button" name="edd_register_submit" type="submit" value="<?php esc_attr_e( 'REGÍSTRESE', 'edd' ); ?>" />
		</p>
