...
*/
if ( $private ) : ?>
	<h3><?php echo sprintf( __( '%s PRIVADAS:', 'edd-wish-lists' ), edd_wl_get_label_plural() ); ?></h3>
...
*/
if ( $public ) : ?>
	<h3><?php echo sprintf( __( '%s PÚBLICAS', 'edd-wish-lists' ), edd_wl_get_label_plural() ); ?></h3>
	<ul class="edd-wish-list">
