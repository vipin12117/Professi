var EDDFES = (function($) {
	...
	function addoption() {
		...
		var option          = optionContainer.find( '.edd-fes-adf-submission-option:last' );
	...
	function removeoption() {
		$( 'body' ).on( 'click', '.edd-fes-adf-submission-option-remove a', function(e) {
			...
			var optionContainer = $( '.edd-fes-adf-submission-options' );
			var count           = optionContainer.find( 'div.edd-fes-adf-submission-option' ).length;

			if ( count == 2 || option.hasClass( 'static' ) )
