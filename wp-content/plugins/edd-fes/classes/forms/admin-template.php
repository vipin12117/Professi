...
class FES_Admin_Template {
    ...
    public static function common( $id, $field_name_value = '', $custom_field = true, $values = array(), $reqtoggle = true ) {
		...
		do_action('edd_fes_add_field_to_common_form_element', $tpl, 'fes_input', $id, $values);
        ?>
    ...
    public static function image_upload( $field_id, $label, $values = array(), $removeable = true, $reqtoggle = true  ) {
        $max_size_name = sprintf('%s[%d][max_size]', 'fes_input', $field_id);
	...
	public static function file_upload( $field_id, $label, $values = array(), $removeable = true, $reqtoggle = true  ) {
        $max_size_name = sprintf('%s[%d][max_size]', 'fes_input', $field_id);
        $max_files_name = sprintf('%s[%d][count]', 'fes_input', $field_id);
        $extensions_name = sprintf('%s[%d][extension][]', 'fes_input', $field_id);
...
function your_function_name( $form_id, $post_id, $form_settings ) {
    ...
    public static function featured_image( $field_id, $label, $values = array() ) {
        $max_file_name = sprintf( '%s[%d][max_size]', 'fes_input', $field_id );
    ...
    public static function password( $field_id, $label, $values = array() ) {
        ...
        $pass_strength_name = sprintf( '%s[%d][pass_strength]', 'fes_input', $field_id );
