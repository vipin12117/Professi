...
$options[] = array(
	 'name' => __( 'Let Vendors Edit Products', 'edd_fes' ),
	 'desc' => __( 'Highly Recommended', 'edd_fes' ),
	 'id'   => 'edd_fes_vendor_permissions_edit_product',
	 'type' => 'checkbox',
	 'std'  => true,
);
$options[] = array(
	 'name' => __( 'Let Vendors Delete Products', 'edd_fes' ),
	 'desc' => __( 'Highly Recommended', 'edd_fes' ),
	 'id'   => 'edd_fes_vendor_permissions_delete_product',
	 'type' => 'checkbox',
	 'std'  => true,
);
$options[] = array(
