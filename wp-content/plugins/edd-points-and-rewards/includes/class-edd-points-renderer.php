...
class EDD_Points_Renderer {
			...
			<div id="edd_points_rewads_fields">
				<table>
					<tr>
						...
						<td>
							<input type="text" class="small-text" value="<?php echo $this->model->edd_points_escape_attr( $points_earned ); ?>" id="_edd_points_earned" name="_edd_points_earned"/>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td>
							<input type="text" class="small-text" value="<?php echo $this->model->edd_points_escape_attr( $max_points_discount ); ?>" id="_edd_points_max_discount" name="_edd_points_max_discount"/>
	...
	public function edd_points_download_category_add_fields_html() {
		...
		<div class="form-field">
			...
			<input type="text" class="small-text" name="edd_points_rewards[edd_points_earned]" id="edd_points_rewards[edd_points_earned]" style="width:50px;"/>
		...
		<div class="form-field">
			...
			<input type="text" class="small-text" name="edd_points_rewards[edd_points_max_discount]" id="edd_points_rewards[edd_points_max_discount]" style="width:50px;"/>
			<?php echo edd_currency_filter('');?>
	...
	public function edd_points_download_category_edit_fields_html( $term ) {
		...
		?>
			<tr class="form-field">
				...
				<td>
					<input type="text" name="edd_points_rewards[edd_points_earned]" id="edd_points[edd_points_earned]" value="<?php echo $this->model->edd_points_escape_attr( $earnedpoints );?>" style="width:50px;"/>
			...
			<tr class="form-field">
				...
				<td>
					<input type="text" class="small-text" name="edd_points_rewards[edd_points_max_discount]" id="edd_points_rewards[edd_points_max_discount]"  value="<?php echo $this->model->edd_points_escape_attr( $maxdiscount );?>" style="width:50px;"/>
					<?php echo edd_currency_filter('');?>
