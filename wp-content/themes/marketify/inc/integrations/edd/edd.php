...
function marketify_wp_nav_menu_items( $items, $args ) {
	...
	$link = sprintf( '<li class="current-cart"><a href="%s"><i class="buy-icon"></i> <span class="edd-cart-quantity" style="">%d </span><span class="text-item"> ARTÍCULO(S)</span></a><ul class="sub-menu nav-menu"><li class="widget">%s</li></ul></li>', get_permalink( edd_get_option( 'purchase_page' ) ), edd_get_cart_quantity(), $widget );
