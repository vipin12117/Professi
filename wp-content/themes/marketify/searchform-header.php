...
<form role="search" method="get" id="quick-search-form" name="quick-search-form" class="search-form-active" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<label>
		...
		<input type="search" id="input-search-field" class="form-control icon-search search-field-input" placeholder="<?php echo esc_attr__( 'Buscar…', 'marketify' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" title="<?php echo esc_attr__( 'Search for:', 'marketify' ); ?>">
	</label>
